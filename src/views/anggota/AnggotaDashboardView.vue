  ...
  <div class="dashboard">
    ...
    <div class="header-section">
      <div class="user-welcome">
        ...
        <p class="member-id">ID Anggota: {{ user.noAnggota }}</p>
      </div>
    ...
    <div class="dashboard-content">
      <div class="tabs">
        ...
        <button
          class="tab-button"
          :class="{ active: activeTab === 'simpanan' }"
          @click="setActiveTab('simpanan')"
        >
          Simpanan
        </button>
        <button
          class="tab-button"
          :class="{ active: activeTab === 'pinjaman' }"
          @click="setActiveTab('pinjaman')"
        >
          Pinjaman
        </button>
        <button
